/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f9d262bbc3170793815e9aabfe6b1097)
// Runtime types generated with workerd@1.20260721.1 2026-07-22 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGINS: "http://localhost:5173,http://127.0.0.1:5173,http://localhost:4173,http://127.0.0.1:4173,https://eternalpond.com,https://www.eternalpond.com";
	WORLD_CAPACITY: "128";
	FOUNDING_RIPPLES: "149";
	PUBLIC_APP_ORIGIN: "https://eternalpond.com";
	RESEND_FROM: "Eternal Pond <pond@eternalpond.com>";
	...
	POND_CORE: DurableObjectNamespace<import("./src/index").PondCoreV2>;
	POND_GATEWAY: DurableObjectNamespace<import("./src/index").PondGatewayV2>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PondCoreV2" | "PondGatewayV2";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "WORLD_CAPACITY" | "FOUNDING_RIPPLES" | "PUBLIC_APP_ORIGIN" | "RESEND_FROM" | "KEEPER_BILLING_ENABLED" | "STRIPE_MONTHLY_PRICE_ID" | "STRIPE_ANNUAL_PRICE_ID" | "STRIPE_PORTAL_CONFIGURATION_ID" | "RESEND_API_KEY" | "RESEND_WEBHOOK_SECRET" | "EMAIL_ENCRYPTION_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "ANALYTICS_BEARER_TOKEN">> {}
}
